...
import { Leaf, Award, Star, Zap, CheckCircle, Target, Menu, Gauge, Users, Gamepad2, BookOpen, Image as ImageIcon } from "lucide-react";
            ...
            <Sheet>
              ...
              <SheetContent side="right" className="p-0">
                ...
                <nav className="grid gap-2 p-4">
                    ...
                    <Link href="/dashboard" className="flex items-center gap-3 rounded-lg px-3 py-2 text-primary bg-muted font-semibold">
